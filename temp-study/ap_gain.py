...
pos_filter = 4  # Replace with the desired pos value
ch_filter =  1 # Replace with the desired ch value
...
for run_filter, run_group in filtered_df.groupby('run'):
    ...
    alpha_data = run_group['lambda']
    alpha_err_data = run_group['lambda_err']
    ...
    alpha_at_ov3 = interp_func_alpha(4.0)
    alpha_err_at_ov3 = interp_func_alpha_err(4.0)
