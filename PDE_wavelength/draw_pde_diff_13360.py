...
plt.hlines(y=pde_415_ov5V, xmin=250, xmax=415, color=color_5V, linestyle=':', alpha=0.5)
plt.text(570, pde_415_ov5V - 20, '$\\frac{\\mathrm{PDE}^{\\,415\\mathrm{nm}}_{\\,5\\mathrm{V}}-\\mathrm{PDE}^{\\,404\\mathrm{nm}}_{\\,5\\mathrm{V}}}{\\mathrm{PDE}^{\\,404\\mathrm{nm}}_{\\,5\\mathrm{V}}} =\\, $'+f'{norm_diff_ov5V*100:.3f}%', verticalalignment='top', horizontalalignment='right', color=color_5V,fontsize=textsize)
