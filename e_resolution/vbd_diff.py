...
for i,file in enumerate(root_files):
    ...
    energy_resolution_final = sigma_gain_nuf3_gas  / mean_gain_nuf3_gas
...
plt.scatter(over_voltages, energy_resolutions_gain_nuf3_uni, label='Uniform NUF0.3V',s=size_marker, marker='o', color='lightcoral')
plt.scatter(over_voltages, energy_resolutions_gain_nuf5_uni, label='Uniform NUF0.5V',s=size_marker, marker='o', color='indianred')
plt.scatter(over_voltages, energy_resolutions_gain_nuf10_uni, label='Uniform NUF1.0V',s=size_marker, marker='o', color='brown')
plt.scatter(over_voltages, energy_resolutions_gain_nuf15_uni, label='Uniform NUF1.5V',s=size_marker, marker='o', color='maroon')
plt.scatter(over_voltages, energy_resolutions_gain_nuf3_gas, label='Gaussian NUF0.3V',s=size_marker, marker='s', color='paleturquoise',facecolors='none')
plt.scatter(over_voltages, energy_resolutions_gain_nuf5_gas, label='Gaussian NUF0.5V',s=size_marker, marker='s', color='deepskyblue',facecolors='none')
plt.scatter(over_voltages, energy_resolutions_gain_nuf10_gas, label='Gaussian NUF1.0V',s=size_marker, marker='s', color='mediumblue',facecolors='none')
plt.scatter(over_voltages, energy_resolutions_gain_nuf15_gas, label='Gaussian NUF1.5V',s=size_marker, marker='s', color='darkblue',facecolors='none')
plt.ylim(0.0,0.01)
...
plt.grid(True)
plt.savefig("energy_res_vbd_nuf.pdf")
